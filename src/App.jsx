...
import DegreeCertificate from "./components/sections/Degree_Certificate";
  ...
  return (
    <>
      ...
      >
        ...
        <SideScroller menuOpen={menuOpen} setMenuOpen={setMenuOpen} />
        {/* <Resume menuOpen={menuOpen} setMenuOpen={setMenuOpen} />
        <DegreeCertificate menuOpen={menuOpen} setMenuOpen={setMenuOpen} /> */}
