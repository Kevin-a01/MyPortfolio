    ...
    <RevealOnScroll>
      <div className={`text-center z-10 px-4`}>
        ...
        <p className={`text-gray-400 text-lg mb-8 max-w-lg mx-auto md:text-xl`}>
          I'm a Frontend-Developer student at EC Utbildning, passionate about learning to craft beautiful and functional web experiences. While I enjoy learning about both Frontend and Backend, the main focus is on the Frontend-Development.
        </p>
