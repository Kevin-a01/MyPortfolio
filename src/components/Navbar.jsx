    ...
    <nav className="fixed top-0 w-full z-40 bg-[rgba(10, 10, 10, 0.8)] backdrop-blur-lg border-b-white/10 shadow-lg">
      <div className="max-w-5xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          <a
            className={`font-mono text-3xl font-bold md:text-4xl text-white transitionn-opacity duration-300 ${menuOpen ? "opacity-35" : "opacity-100"}`}
            href="/MyPortfolio"
          >
          ...
          {!menuOpen && (
            <div
              className="w-7 h-7 relative cursor-pointer text-xl z-40 md:hidden"
